...
def home(request):
    ...
    if request.method == 'GET':
        return render(request, 'home/home.html', {'form':BlogForm(), 'comments':comments})
    else:
        try:
            ...
            return render(request, 'home/home.html', {'form':BlogForm(), 'error':'Введены неверные параметры'})
